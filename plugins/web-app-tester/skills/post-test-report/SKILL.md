...
| `PLAN_SOURCE` | gather-test-context | How the test plan was obtained — one of: `auto-generated by web-app-tester`, `found in {PR | issue | work item} description` (naming the actual entry type), `sourced from acceptance criteria`, `sourced from bug repro steps` |

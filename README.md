...
|--------|---------|-------------|----------|
| [arch-fitness](./plugins/arch-fitness) | 1.0.0 | Architecture fitness plugin. Discovers or bootstraps architecture-constraint documents in a repository, opens a docs PR when created or updated, then evaluates a requested changeset scope (a PR, a branch, or PRs merged in a date window) against those constraints and reports the few most important improvements. Works with GitHub, Azure DevOps, and any git repository. | architecture |
...
| [pr-reviewer](./plugins/pr-reviewer) | 1.9.9 | Comprehensive PR review with specialized agents for code quality, security, test coverage, and performance analysis. Works with GitHub, Azure DevOps, Bitbucket, and any git repository. | code-review |
